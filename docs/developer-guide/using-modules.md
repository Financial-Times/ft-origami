...
<tr><td>Unopinionated about your server-side technology stack</td><td>No.  You will need Node.js (for package management and build automation)</td><td>Yes, there is no requirement for any server-side code</td></tr>
