...
We've published a set of [principles]({{site.baseurl}}/docs/principles) that will guide the development of a new generation of components to gradually replace what we have today.  Here's the FT.com homepage, and how it might be divided into components:
